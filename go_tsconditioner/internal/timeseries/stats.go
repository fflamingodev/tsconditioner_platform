...
// MeanSkipNaN returns the arithmetic mean ignoring NaN values.
// If all values are NaN or input is empty, it returns math.NaN() and ErrEmptyInput.
func MeanSkipNaN(input []float64) (float64, error) {
	if len(input) == 0 {
